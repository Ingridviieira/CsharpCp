...
namespace ProjCp1.Controllers
{
    public class RoupasController : Controller
    {
        private readonly Contexto _context;

        public RoupasController(Contexto context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Roupas != null ? 
                          ...
                          Problem("Entity set 'Contexto.Roupas'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Tipo,Tecido")] Roupas roupas)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Tipo,Tecido")] Roupas roupas)
        {
            if (id != roupas.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Contexto.Roupas'  is null.");
            }
            var roupas = await _context.Roupas.FindAsync(id);
            if (roupas != null)
            {
